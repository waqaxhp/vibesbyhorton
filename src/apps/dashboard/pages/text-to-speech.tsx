  ...
  return (
    <div className="bg-[#0B0D11] text-white min-h-screen p-6">
      ...
      <p className="mb-6 max-w-2xl text-gray-300">
        Enter any text in the box below and select a voice from the list to hear
        it spoken aloud. Use the sample text button for a quick demonstration.
      </p>

      <div className="grid grid-cols-12 gap-6">
        {/* Left Section */}
        <div
          className="col-span-12 md:col-span-6 p-2 flex flex-col bg-gray-900 border border-gray-700"
          style={{ minHeight: "320px" }}
        >
          <label htmlFor="textInput" className="mb-2 font-semibold text-lg">
            Enter Text
          </label>
          <textarea
            id="textInput"
            value={text}
            onChange={(e) => setText(e.target.value)}
            className="w-full flex-grow p-4 rounded bg-gray-800 text-white resize-none"
            placeholder="Enter your text here..."
          />
          <div className="flex justify-between items-center mt-2">
            ...
            <button
              ...
              className="bg-gray-800 cursor-pointer text-white px-6 py-2 rounded hover:bg-gray-700 transition"
            >
              Sample Text
            </button>
          </div>
        ...
        <div
          ...
          style={{ minHeight: "320px" }}
        >
          <div className="bg-gray-900 p-4 rounded shadow-md h-full flex flex-col">
            <h2 className="text-xl font-semibold mb-3">Voice List</h2>
